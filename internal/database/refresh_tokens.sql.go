...
SELECT users.id, users.created_at, users.updated_at, users.first_name, users.last_name, users.contact_number, users.address, users.email, users.hashed_password, users.role FROM refresh_tokens 
INNER JOIN users
